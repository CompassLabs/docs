...
<CodeBlock url="https://github.com/CompassLabs/dojo_examples/blob/main/policies/price_window.py" snippet_name={"price_window"}/>
...
<CodeBlock url="https://github.com/CompassLabs/dojo_examples/blob/main/policies/dynamic_price_window.py" snippet_name={"dynamic_price_window"}/>
